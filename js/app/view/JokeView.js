define([], function() {
	return Backbone.View.extend({
		...
		//$stars: null,
		jokeModel_cid: '', starRatingWidth: '', jokeAuthor_cid : '', title: '', ratings: '', joke: '', jokeAuthor: '', date: '',
		...
		render: function(){
            var variables = { jokeModel_cid: this.jokeModel_cid, starRatingWidth: this.starRatingWidth, jokeAuthor_cid: this.jokeAuthor_cid, title: this.title, ratings: this.ratings, joke: this.joke, jokeAuthor: this.jokeAuthor , date: this.date};
